...
/**
 * OpenAI LLM Driver - Für Cloud-basierte LLM-Inferenz.
 */
class OpenAIDriver implements LLMDriverInterface
{
    ...
    {
        // OpenAI hat keine separate generate API, nutze chat
        return $this->chat([
    ...
    public function chat(array $messages, array $options = []): string
    {
        ...
        try {
            ...
            if ($response->failed()) {
                Log::channel('entity')->error('OpenAI chat failed', [
            ...
            Log::channel('entity')->error('OpenAI chat exception', [
                'error' => $e->getMessage(),
            ]);
